...
书影来自 [哈佛大学燕京图书馆](http://id.lib.harvard.edu/alma/990081438170203941/catalog)。
...
4. 通用方案中的声母 dj 在本书中被拼为 g,。如「虫」拼为 g,ong。
5. 通用方案中的音节 un 在本书中被拼为 w̆un。
6. 通用方案中词语开头的大写字母 Ü 在本书中被拼为 U（也可能为错印）。
7. 偶有不分 w̆ 和 w（也可能为错印）。
